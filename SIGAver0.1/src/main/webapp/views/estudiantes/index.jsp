                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-6 text-end">
                            <a href="/solicitar-aseso" class="btn btn-outline-success btn-sm">
                                Solicitar nueva asosria
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        <c:forEach var="asesoria" items="${asesorias}" varStatus="status">
                            <tr>
                                ...
                                <td>
                                    ...
                                    btn-sm">EDITAR</a>
                                    <form action="cancel-aseso" method="post">
                                        <input type="hidden" value="${asesoria.id}" name="id"/>
